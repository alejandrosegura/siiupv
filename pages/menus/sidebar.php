...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="#"><i class="fa fa-link"></i> <span>Alumnos</span></a></li>
      <li><a href="#"><i class="fa fa-link"></i> <span>Aulas</span></a></li>
      <li><a href="#"><i class="fa fa-link"></i> <span>Carreras</span></a></li>
      <li><a href="#"><i class="fa fa-link"></i> <span>Clases</span></a></li>
      ...
      <li><a href="#"><i class="fa fa-link"></i> <span>Materias</span></a></li>
      <li><a href="#"><i class="fa fa-link"></i> <span>Personas</span></a></li>
      <li><a href="#"><i class="fa fa-link"></i> <span>Aulas</span></a></li>
